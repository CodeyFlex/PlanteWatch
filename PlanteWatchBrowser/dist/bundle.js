...
new Vue({
    ...
    methods: {
        ...
        async getAllPlantsAsync(initBool) {
            ...
            try {
                return _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(planteWatchPlantURL);
            }
            catch (any) {
        ...
        async getAllGreenhousesAsync(initBool) {
            ...
            try {
                return _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(planteWatchgreenhouseURL);
            }
            catch (any) {
                this.message = any.message;
                alert(any.message);
        ...
        getPlantByName(name) {
            ...
            let url = planteWatchPlantURL + "/Name/" + name;
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(url)
                .then((response) => {
        ...
        getGreenhouseByName(name) {
            ...
            let url = planteWatchgreenhouseURL + "/Name/" + name;
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(url)
                .then((response) => {
